...
export const DESTINATIONS = [
  { id: 'reception', label: 'Reception', category: 'help', icon: '/icons/receptionicon.jpg', x: 0.5, y: 0.5 },
  { id: 'cafe', label: 'Café', category: 'food', icon: '/icons/cafe_icon.jpg', x: 6.5, y: 0.5 },
  { id: 'lecture-101', label: 'Lecture Hall 101', category: 'rooms', icon: '/icons/lecture_hallicon.jpg', x: 0.5, y: 4.5 },
  { id: 'lab-a', label: 'Lab A', category: 'rooms', icon: '/icons/lab_a_icon.jpeg', x: 6.5, y: 4.5 },
  { id: 'restrooms', label: 'Restrooms', category: 'facilities', icon: '/icons/restroomsicon.jpeg', x: 3.5, y: 0.5 },
  // The building's vertical-circulation core: stairs and lift sit side by side.
  { id: 'elevator', label: 'Elevator', category: 'facilities', icon: '/icons/elevatoricon.jpeg', x: 2.5, y: 4.5 },
  { id: 'stairs', label: 'Stairs', category: 'facilities', icon: '/icons/stairs_icon.jpeg', x: 4.5, y: 4.5 },
  { id: 'exit', label: 'Main Exit', category: 'exits', icon: '/icons/exit.jpeg', x: 3.5, y: 4.5 },
];
...
export const ROUTE_PREFERENCES = [
  { id: 'fastest', label: 'Fastest route', icon: '/icons/fast.jpeg', hint: 'Shortest path' },
  { id: 'step-free', label: 'Step-free', icon: '/icons/behindert.jpeg', hint: 'Avoid stairs' },
  { id: 'quiet', label: 'Avoid crowds', icon: '/icons/avoid_crowds_pathing.jpeg', hint: 'Quieter corridors' },
];
